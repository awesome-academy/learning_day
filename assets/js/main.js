$(function() {
    ...
    var heights = $(".should-min-height").map(function ()
    {
        return $(this).height();
    }).get();
    ...
    $(".should-min-height").height(maxHeight);
});
